...
export const InvoiceLedgerTable: React.FC<InvoiceLedgerTableProps> = ({
  ...
  return (
    <div className="max-w-7xl mx-auto py-6 px-4 space-y-4">
      {/* Top Banner & Audit Stats (1:1 纯白圆角卡片样式，匹配图 1) */}
      ...
      {/* Control Bar: Search & Filter (纯白圆角卡片样式，匹配图 1) */}
        ...
        <div className="flex flex-wrap items-center space-x-3 gap-y-2">
          ...
          <div className="flex items-center space-x-1">
            ...
            <select
              ...
              className="border border-slate-300 text-xs rounded-xl px-3 py-1.5 focus:outline-none cursor-pointer font-bold bg-slate-50 text-slate-800"
            >
