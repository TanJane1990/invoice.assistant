...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-xs p-4 overflow-y-auto">
      <div className="bg-white dark:bg-[#0E1422] rounded-2xl shadow-2xl max-w-2xl w-full overflow-hidden border border-slate-200 dark:border-slate-800 my-8">
        {/* Header */}
        ...
        <div className="p-6 space-y-5 max-h-[75vh] overflow-y-auto text-xs text-slate-900 dark:text-slate-100">
          ...
          <div className="space-y-3 bg-[#F8FAFC] dark:bg-[#131B2E] p-4.5 rounded-xl border border-slate-200 dark:border-slate-800">
            ...
            <div>
              ...
              <input
                ...
                className="w-full p-2.5 bg-white dark:bg-[#0E1422] text-slate-900 dark:text-slate-100 border border-slate-300 dark:border-slate-700 rounded-xl font-mono focus:ring-2 focus:ring-red-500 focus:outline-none"
              />
            </div>
          </div>
          ...
          <div className="space-y-3 bg-[#F8FAFC] dark:bg-[#131B2E] p-4.5 rounded-xl border border-slate-200 dark:border-slate-800">
            <div className="flex items-center justify-between">
              ...
              <a
                ...
                className="inline-flex items-center space-x-1.5 text-xs text-purple-700 dark:text-purple-300 font-bold bg-purple-50 dark:bg-purple-950/80 hover:bg-purple-100 px-3 py-1 rounded-lg border border-purple-200 dark:border-purple-800 transition-colors cursor-pointer"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  className="w-full p-2 bg-white dark:bg-[#0E1422] text-slate-900 dark:text-slate-100 border border-slate-300 dark:border-slate-700 rounded-xl font-mono"
                />
              </div>
              <div>
                <label className="block text-slate-700 dark:text-slate-300 font-bold mb-1">
          ...
          <div className="space-y-3 bg-[#F8FAFC] dark:bg-[#131B2E] p-4.5 rounded-xl border border-slate-200 dark:border-slate-800">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                <label className="block text-slate-700 dark:text-slate-300 mb-1 font-bold">默认单位名称</label>
                <input
                  type="text"
                  ...
                  className="w-full p-2 bg-white dark:bg-[#0E1422] text-slate-900 dark:text-slate-100 border border-slate-300 dark:border-slate-700 rounded-xl"
                />
              </div>

              <div>
                <label className="block text-slate-700 dark:text-slate-300 mb-1 font-bold">默认报销部门</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-slate-700 dark:text-slate-300 mb-1 font-bold">默认报销人</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-slate-700 dark:text-slate-300 mb-1 font-bold">主管审批人</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-slate-700 dark:text-slate-300 mb-1 font-bold">财务复核人</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-slate-700 dark:text-slate-300 mb-1 font-bold">出纳或经办人</label>
                <input
                  type="text"
        ...
        {/* Footer */}
        <div className="bg-slate-50 dark:bg-[#0B0F19] px-6 py-4 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <button
              onClick={onClose}
              className="px-4 py-2 bg-slate-200 dark:bg-slate-800 hover:bg-slate-300 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 font-bold text-xs rounded-xl cursor-pointer transition-colors"
            >
              取消
            </button>
            <button
              onClick={handleSave}
              className="flex items-center space-x-1.5 px-5 py-2 bg-red-600 hover:bg-red-700 text-white font-bold text-xs rounded-xl shadow-md shadow-red-200 dark:shadow-none transition-all cursor-pointer min-w-[120px] justify-center"
            >
              {savedSuccess ? (
                <>
